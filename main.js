requirejs.config({
    paths: {
        ...
        Bootstrap: 'javascript/libs/bootstrap.min',
        DateFormat: 'javascript/libs/date.format',
        XPlans: 'javascript/libs/xplans',
        DDLBuilder: 'javascript/libs/ddl_builder',
        utils: 'javascript/fiddle_backbone/utils',
        fiddle_backbone:'javascript/fiddle_backbone'
    },
    map: {
        "*": {
